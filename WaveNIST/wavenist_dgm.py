...
train_data = datasets.MNIST(root="WaveNIST", train=True, transform=input_transforms, download=True)
val_data = datasets.MNIST(root="WaveNIST", train=False, transform=input_transforms, download=True)
