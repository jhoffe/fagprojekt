...
#BSUB -o logs/synthetic_generate_test_other_%J.out
#BSUB -e logs/synthetic_generate_test_other_%J.err
#BSUB -q gpua100
...
LS_DATASET_TYPE="test-other" python3 -m synthetic_gen.generate
